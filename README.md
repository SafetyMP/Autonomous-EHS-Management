...
> **Permit rule:** AI may draft; a named human closes the record. No FidusGate receipt on that write path yet. Same instinct, other exhibits: [SafetyMP](https://github.com/SafetyMP/SafetyMP).
