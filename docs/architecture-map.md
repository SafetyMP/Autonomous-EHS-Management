...
| **Planned / partner-built** | — | ERP, LMS/HRIS productized catalogs, e-signature, and document DMS integrations remain roadmap—architecture supports org-scoped events and auditability. |
