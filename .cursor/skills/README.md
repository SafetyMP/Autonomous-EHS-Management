...
| QA engineer | [qa-engineer/SKILL.md](qa-engineer/SKILL.md) | Risk-based plans, release readiness, exploratory charters; delegates runnable automation to Senior QA automation |
